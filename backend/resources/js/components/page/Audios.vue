      ...
      <b-input-group class="search">
        <template #prepend>
          <b-dropdown :text="subGenreSelected.text">
            <b-dropdown-item
              @click="selectSubgenre({ value: null, text: 'すべての音源' })"
              >すべての音源</b-dropdown-item
            >
            <b-dropdown-item
      ...
      <div class="d-flex flex-nowrap bd-highlight">
        ...
        <b-col cols="3" class="scroll-child">
          <av-waveform
            class="player"
            :id="'audio' + stock.id"
            :audio-src="'/storage/stock_sample/' + stock.filename + '.mp3'"
        ...
        <b-col cols="5">
          <div class="scroll-parent">
            <div class="scroll-child">
              ...
              <a href="#" class="badge mb-3 mb-sm-0 badge-secondary">
                セリフ
              </a>
              <a href="#" class="badge mb-3 mb-sm-0 badge-secondary">
                ビジネスマン
...
export default {
  ...
  methods: {
    ...
    async showArchive() {
      ...
      console.log(this.stocks[1].fileInfo.time);
    ...
    changePage(number) {
      ...
      if (this.subGenreSelected.value && this.keyword) {
        ...
        $url = `${window.location.origin}/audio?subgenre=${this.subGenreSelected.value}&key=${this.keyword}&page=${this.current_page}`;
      } else if (this.subGenreSelected.value && !this.keyword) {
        //console.log('サブジャンルの指定はあるが、キーワードの指定はない')
        $url = `${window.location.origin}/audio?subgenre=${this.subGenreSelected.value}&page=${this.current_page}`;
      } else if (!this.subGenreSelected.value && !this.keyword) {
